<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="dashboard.jsp" class="brand-link"> <img
		src="newtemp/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
		class="brand-image img-circle elevation-3" style="opacity: .8">
		<span class="brand-text font-weight-light">POWERAPPS IPL</span>
	</a>
	<!-- Sidebar -->
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="newtemp/dist/img/user2-160x160.jpg"
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item has-treeview menu-open"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">						
						<li class="nav-item"><a href="datatable.jsp"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>DataTables</p>
						</a></li>
						<li class="nav-item"><a href="LogusrServ"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>User Logged-in Details</p>
						</a></li>
						<li class="nav-item"><a href="EmpMst"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Employee Master Search</p>
						</a></li>
