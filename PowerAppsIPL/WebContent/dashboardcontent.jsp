<div class="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="card-body">
							...
							<div class="direct-chat-messages">
								...
								<div class="direct-chat-msg">
									...
									<img class="direct-chat-img"
										src="newtemp/dist/img/user1-128x128.jpg"
								...
								<div class="direct-chat-msg right">
									...
									<!-- /.direct-chat-infos -->
									<img class="direct-chat-img"
										src="newtemp/dist/img/user3-128x128.jpg"
										alt="message user image">
									<!-- /.direct-chat-img -->
							...
							<div class="direct-chat-contacts">
								<ul class="contacts-list">
									...
									<!-- End Contact Item -->
									<li><a href="#"> <img class="contacts-list-img"
											src="newtemp/dist/img/user7-128x128.jpg">
									...
									<!-- End Contact Item -->
									<li><a href="#"> <img class="contacts-list-img"
											src="newtemp/dist/img/user5-128x128.jpg">
									...
									<!-- End Contact Item -->
									<li><a href="#"> <img class="contacts-list-img"
											src="newtemp/dist/img/user6-128x128.jpg">
									...
									<!-- End Contact Item -->
									<li><a href="#"> <img class="contacts-list-img"
											src="newtemp/dist/img/user8-128x128.jpg">
					...
					<section class="col-lg-5 connectedSortable"> <!-- Map card -->
	...
	<!-- jQuery UI 1.11.4 -->
	<script src="newtemp/plugins/jquery-ui/jquery-ui.min.js"></script>
  ...
  $.widget.bridge('uibutton', $.ui.button)
	...
	<!-- ChartJS -->
	<script src="newtemp/plugins/chart.js/Chart.min.js"></script>
	<!-- Sparkline -->
	<script src="newtemp/plugins/sparklines/sparkline.js"></script>
	<!-- JQVMap -->
	<script src="newtemp/plugins/jqvmap/jquery.vmap.min.js"></script>
	<script src="newtemp/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
	<!-- jQuery Knob Chart -->
	<script src="newtemp/plugins/jquery-knob/jquery.knob.min.js"></script>
	<!-- daterangepicker -->
	<script src="newtemp/plugins/moment/moment.min.js"></script>
	<script src="newtemp/plugins/daterangepicker/daterangepicker.js"></script>
	<!-- Tempusdominus Bootstrap 4 -->
	<script
		src="newtemp/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
	<!-- Summernote -->
	<script src="newtemp/plugins/summernote/summernote-bs4.min.js"></script>
	<!-- overlayScrollbars -->
	<script
		src="newtemp/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
	<!-- AdminLTE App -->
	<script src="newtemp/dist/js/adminlte.js"></script>
	<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
	<script src="newtemp/dist/js/pages/dashboard.js"></script>
